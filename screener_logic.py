...
def process_single_resume_logic(file_name, text, jd_text, 
    ...
    try:
        ...
        hr_summary = generate_detailed_gemini_assessment(
    name=candidate_name,
...
def generate_detailed_gemini_assessment(
    name,
    job_title,
    jd_text,
    resume_text,
    ...
    try:
        ...
        prompt = f"""
You are a senior HR professional writing an internal evaluation.
...
"""
        ...
        return f"""
### Fit Summary
{name} demonstrates partial alignment with the {job_title} role based on resume evaluation.

### Strengths
- Relevant experience: {experience} years
- Matched skills: {matched_skills or "Limited overlap"}

### Weaknesses
- Missing skills: {missing_skills or "Not critical"}

### Overall Role Fit
Moderate fit with room for improvement.

### Final HR Recommendation
Candidate may be considered with targeted upskilling and role-specific training.
"""
