...
def blog_sidebar_content():
    st.markdown("### 🔎 Search Insights")
    return st.text_input("", placeholder="Type here...", label_visibility="collapsed")
...
def main():
    ...
    # --- NAVIGATION & SEARCH ---
    search_query = render_universal_sidebar("ScreenerPro Insights", blog_sidebar_content)
